...
module ascii_rom(
	...
	always @*
		case(addr_reg)
			...
			11'h775: data = 8'b11000110;	//x
			11'h776: data = 8'b11000110;	//x
			11'h777: data = 8'b11010110;	//x
			11'h778: data = 8'b11010110;	//x
			11'h779: data = 8'b11010110;	//x
			11'h77a: data = 8'b01101100;	//x
